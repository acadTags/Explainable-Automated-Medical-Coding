...
path = get_tmpfile("%s/word-emb-mimic3-tr-%s.model" % (MIMIC_3_DIR,dim)) # tr: from training data only
...
model = Word2Vec.load("%s/word-emb-mimic3-tr-%s.model" % (MIMIC_3_DIR,dim))
