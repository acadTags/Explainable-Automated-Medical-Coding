...
* Explainable Automated Coding of Clinical Notes using Hierarchical Label-Wise Attention Networks and Label Embedding Initialisation, submitted to *Journal of Biomedical Informatics*.[Preprint](https://arxiv.org/abs/2010.15728v1) is available on Arxiv.
